...
function VideoPlaceholder() {
  return (
    <div
      className="w-full max-w-[576px] md:max-w-[768px] lg:max-w-[960px] mx-auto h-[176px] sm:h-[256px] md:h-[432px] lg:h-[540px] relative rounded-[12px] overflow-hidden shrink-0"
      style={{
